...
model = tf.keras.Sequential([
    # määritellään neuroverkon piilotettu kerros. 10 neuronia (2 inputs), activation funktio = rectified lineaarifunction, input kerros (input_shape) = input arvojen lukumäärä
...
model.compile(optimizer=keras.optimizers.Adam(learning_rate=0.001), #'adam', #tf.train.AdamOptimizer(0.001),
